...
const abdulloFunction = () => {
  ...
  function createProductBlock() {
    ...
    weightIcon.src = "icons/Весы.png";
    weightIcon.className = "icons";
    const heartIcon = document.createElement("img");
    heartIcon.src = "icons/Сердечко.png";
...
const safariMuhammadANDBoboevFunction = () => {
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const sectionOne = createSection([
      ...
      },
      {
        ...
        links: ["Контактная информация", "Возврат товара", "Карта сайта"],
      },
      {
        title: "ДОПОЛНИТЕЛЬНО",
        links: ["Подарочные сертификаты", "Партнеры", "Товары со скидкой"],
      },
      {
  ...
  function createContacts() {
    ...
    const contacts = [
      ...
      {
        icon: "icons/clocke.png",
        text: "Пн-Пт 7:00 - 16:00 (МСК)",
      },
      {
        icon: "icons/locationLogo.png",
        text: "Златоуст, ул. Шоссейная, д. 1, офис «6Б»",
      },
      {
        icon: "icons/mailLogo.png",
...
safariMuhammadANDBoboevFunction();
